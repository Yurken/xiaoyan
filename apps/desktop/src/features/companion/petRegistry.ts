...
const whiteDumplingTooltips: Partial<Record<CompanionActionKey, string>> = {
  ...
  planning: "白团子在脑内搭建小计划。",
  searching: "白团子正在帮你筛资料。",
  reading: "白团子认真读着研究材料。",
  writing: "白团子抱紧笔记本，准备整理成文。",
  summarizing: "白团子正在综合结论。",
  looking: "白团子观察了一下当前进展。",
  peeking: "白团子探头看了看你的操作。",
  celebrating: "白团子开心地庆祝了一下。",
  alerting: "白团子提醒你这里需要注意。",
  arriving: "白团子抱着笔记本赶来。",
  resting: "白团子准备软乎乎地休息。",
