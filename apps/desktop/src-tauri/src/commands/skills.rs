...
fn builtin_skills() -> &'static [BuiltinSkill] {
    &[
        ...
        BuiltinSkill {
            ...
            name: "simplify",
            title: "简化技术描述",
            description: "去除冗余，将复杂技术内容提炼为清晰、精准的表达",
        ...
        BuiltinSkill {
            ...
            name: "polish",
            title: "学术文稿精修",
            description: "对学术文本进行最终精修，改善流畅度、逻辑衔接和用词准确性",
        ...
        BuiltinSkill {
            ...
            name: "peer-review",
            title: "模拟同行评审",
            description: "以顶会审稿人视角对论文进行综合评审，给出评分与修改意见",
        ...
        BuiltinSkill {
            ...
            name: "code-explain",
            title: "代码逻辑解析",
            description: "逐步解析代码的核心逻辑、设计意图和关键细节",
        ...
        BuiltinSkill {
            ...
            name: "code-review",
            title: "代码质量审查",
            description: "审查代码的正确性、可读性和效率，给出具体改进意见",
        ...
        BuiltinSkill {
            ...
            name: "checklist",
            title: "投稿前核查清单",
            description: "生成针对目标期刊/会议的投稿前核查清单，确保质量和格式符合要求",
