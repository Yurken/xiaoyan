...
use commands::{
    ...
    desktop_assistant_file_shelf::{
        assistant_file_shelf_copy, assistant_file_shelf_list, assistant_file_shelf_remove,
        assistant_file_shelf_reveal, assistant_file_shelf_stash_clipboard,
        assistant_file_shelf_stash_paths,
    },
...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            assistant_file_shelf_stash_paths,
            assistant_file_shelf_stash_clipboard,
            assistant_file_shelf_copy,
            assistant_file_shelf_remove,
            assistant_file_shelf_reveal,
